...
cov_factor = {  'BkgFixedIlluminantScale_1_00_to_1_00.mat', ...
                'BkgFixedIlluminantScale_0_95_to_1_05.mat', ...
                'BkgFixedIlluminantScale_0_90_to_1_10.mat', ...
                'BkgFixedIlluminantScale_0_85_to_1_15.mat', ...
                'BkgFixedIlluminantScale_0_80_to_1_20.mat', ...
                'BkgFixedIlluminantScale_0_75_to_1_25.mat', ...
                'BkgFixedIlluminantScale_0_70_to_1_30.mat'};
        ...
        for iterAverage = 1:nAverage
            ...
            for iterCovariance = 1:length(cov_factor)
                ...
                if (iterCovariance == 1)
                    ...
                    % Load the images to be analyzed
                    pathToStimulus = fullfile('Experiment7/LMSImages',cov_factor{iterCovariance});
                    ...
                    % Load the images to be analyzed
                    pathToStimulus = fullfile('/Users/vijaysingh/Documents/EquivalentNoisePaper/Experiment7/LMSImages',cov_factor{iterCovariance});
                    stimulusFile = load(pathToStimulus);
...
covScalar = [0.0, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30];
% save('modelThresholdsMeanSubjectExp7.mat', 'covScalar', 'modelThresholds', 'decisionSigma', 'surroundValue');
