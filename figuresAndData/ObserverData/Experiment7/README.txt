...
The data was collected three times at each condition. There were 7 conditions and the subject selection condition, so a total of 8 conditions.
...
The first column gives the name of the condition. The names provide the value of the range parameter.
Each row gives the subject threshold these values of the range parameter.
