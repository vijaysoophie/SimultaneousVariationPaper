% This script plots Figure 7 for Experiment 6.
%
...
% lFitLabel{3} = ['SDT \{$\sigma_i, \sigma_{e0}$\} = ','\{',num2str(sqrt(tsdSigma2_i),3), ', ', num2str(sqrt(tsdSigma2_e),3),'\}'];
