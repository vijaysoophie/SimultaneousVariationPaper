% This script plots Figure S5 for log threshold for Experiment 7. This is
% similar to Figure 9, but includes the thresholds of all observers. Figure
% 9 excludes the thresholds of one of the observer (Observer oven).
%
...
clear; % close all;
%% Load .csv file
dataFile = importfileForFigure9('../ObserverData/Experiment7/subjectThreshold.csv');
